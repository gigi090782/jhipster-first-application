...
export const ClientDeleteDialog = (props: IClientDeleteDialogProps) => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="jhipsterFirstApplicationApp.client.delete.question">
        <Translate contentKey="jhipsterFirstApplicationApp.client.delete.question" interpolate={{ id: clientEntity.id }}>

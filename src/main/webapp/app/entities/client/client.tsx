  ...
  return (
    <div>
      <h2 id="client-heading">
        <Translate contentKey="jhipsterFirstApplicationApp.client.home.title">Clients</Translate>
        <Link to={`${match.url}/new`} className="btn btn-primary float-right jh-create-entity" id="jh-create-entity">
          <FontAwesomeIcon icon="plus" />
          &nbsp;
          <Translate contentKey="jhipsterFirstApplicationApp.client.home.createLabel">Create new Client</Translate>
        </Link>
      </h2>
        ...
        {clientList && clientList.length > 0 ? (
            ...
            <thead>
              <tr>
                ...
                <th className="hand" onClick={sort('firstName')}>
                  <Translate contentKey="jhipsterFirstApplicationApp.client.firstName">First Name</Translate>{' '}
                  <FontAwesomeIcon icon="sort" />
                </th>
                <th className="hand" onClick={sort('lastName')}>
                  <Translate contentKey="jhipsterFirstApplicationApp.client.lastName">Last Name</Translate> <FontAwesomeIcon icon="sort" />
                </th>
                <th className="hand" onClick={sort('birthDate')}>
                  <Translate contentKey="jhipsterFirstApplicationApp.client.birthDate">Birth Date</Translate>{' '}
                  <FontAwesomeIcon icon="sort" />
                </th>
                <th className="hand" onClick={sort('dateAdd')}>
                  <Translate contentKey="jhipsterFirstApplicationApp.client.dateAdd">Date Add</Translate> <FontAwesomeIcon icon="sort" />
                </th>
                <th />
              </tr>
            </thead>
          ...
          !loading && (
            <div className="alert alert-warning">
              <Translate contentKey="jhipsterFirstApplicationApp.client.home.notFound">No Clients found</Translate>
            </div>
          )
        )}
      </div>

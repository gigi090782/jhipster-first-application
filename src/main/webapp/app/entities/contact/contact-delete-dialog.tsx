...
export const ContactDeleteDialog = (props: IContactDeleteDialogProps) => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="jhipsterFirstApplicationApp.contact.delete.question">
        <Translate contentKey="jhipsterFirstApplicationApp.contact.delete.question" interpolate={{ id: contactEntity.id }}>

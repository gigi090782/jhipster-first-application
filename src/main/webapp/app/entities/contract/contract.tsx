...
export const Contract = (props: IContractProps) => {
  ...
  const { contractList, match, loading, totalItems } = props;
  return (
    <div>
      <h2 id="contract-heading">
        <Translate contentKey="jhipsterFirstApplicationApp.contract.home.title">Contracts</Translate>
        <Link to={`${match.url}/new`} className="btn btn-primary float-right jh-create-entity" id="jh-create-entity">
          <FontAwesomeIcon icon="plus" />
          &nbsp;
          <Translate contentKey="jhipsterFirstApplicationApp.contract.home.createLabel">Create new Contract</Translate>
        </Link>
      </h2>
        ...
        {contractList && contractList.length > 0 ? (
                ...
                <tr key={`entity-${i}`}>
                  ...
                  <td className="text-right">
                    <div className="btn-group flex-btn-group-container">
                      ...
                      <Button
                        tag={Link}
                        to={`${match.url}/${contract.id}/edit?page=${paginationState.activePage}&sort=${paginationState.sort},${paginationState.order}`}
                        color="primary"
                        size="sm"
                      >
                      ...
                      <Button
                        tag={Link}
                        to={`${match.url}/${contract.id}/delete?page=${paginationState.activePage}&sort=${paginationState.sort},${paginationState.order}`}
                        color="danger"
                        size="sm"
                      >
          ...
          !loading && (
            <div className="alert alert-warning">
              <Translate contentKey="jhipsterFirstApplicationApp.contract.home.notFound">No Contracts found</Translate>
            </div>
          )
        )}
      </div>

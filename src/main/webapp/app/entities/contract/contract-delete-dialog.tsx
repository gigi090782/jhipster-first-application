...
export const ContractDeleteDialog = (props: IContractDeleteDialogProps) => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="jhipsterFirstApplicationApp.contract.delete.question">
        <Translate contentKey="jhipsterFirstApplicationApp.contract.delete.question" interpolate={{ id: contractEntity.id }}>
      ...
      <ModalFooter>
        ...
        <Button id="jhi-confirm-delete-contract" color="danger" onClick={confirmDelete}>

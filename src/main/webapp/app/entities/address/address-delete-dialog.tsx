...
export const AddressDeleteDialog = (props: IAddressDeleteDialogProps) => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="jhipsterFirstApplicationApp.address.delete.question">
        <Translate contentKey="jhipsterFirstApplicationApp.address.delete.question" interpolate={{ id: addressEntity.id }}>

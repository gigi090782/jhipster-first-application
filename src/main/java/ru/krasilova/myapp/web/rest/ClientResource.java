...
import ru.krasilova.myapp.domain.Client;
import ru.krasilova.myapp.service.ClientService;
...
/**
 * REST controller for managing {@link ru.krasilova.myapp.domain.Client}.
 */
@RestController
@RequestMapping("/api")

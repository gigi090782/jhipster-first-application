...
import ru.krasilova.myapp.domain.Contact;
import ru.krasilova.myapp.service.ContactService;
...
/**
 * REST controller for managing {@link ru.krasilova.myapp.domain.Contact}.
 */
@RestController
@RequestMapping("/api")
